...
import sys
from w2v_demo.utils import NegativeSampler

from w2v_demo.models import SkipGramModel, CBOWModel, NNLMModel
import logging
from w2v_demo.data import load
from w2v_demo.analogies import analogy_test, analogies
...
# python3 w2v_demo/main.py --gin-config-file=w2v_demo/configs/cbow.gin
# python3 w2v_demo/main.py --gin-config-file=w2v_demo/configs/skipgram.gin
